...
class Student_manager {
  ...
  add_student(name: string) {
    ...
    console.log(
      `Student: ${name} added succesfully. Student ID: ${student.id}`
    );
  }
  ...
  view_student_balance(student_id: number) {
    ...
    if (student) {
      ...
      console.log("Student not found. Please enter a corrct ID");
    }
  }
...
async function main() {
  console.log(chalk.bgYellow.bold("\tStudent Management System\t"));
